...
def main():
	...
	p.add_argument("--trace", choices=list(map(lambda x: x.name.lower(), TraceMode.__members__.values())), default=TraceMode.NONE.name.lower(), help="Generate an instr/mem trace. Helpful for debugging.")
